...
<div class="block-header">
    ...
    <ol class="breadcrumb breadcrumb-col-orange">
        ...
        <li class="active">IMPORTER DES SOUS DOMAINES</li>

    </ol>



    <small>Afin d'importer des donnees, choisissez un fichier excel puis cliquer sur le bouton <strong>Importer</strong></small>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="card">
            ...
            <div class="header">
                ...
                <h2>IMPORTER DES SOUS DOMAINES</h2>
            ...
            @endif
                ...
                <form id="form_advanced_validation" method="POST" action="{{action('SubDomain\SubDomainController@import')}}" enctype="multipart/form-data">
                    ...
                    <a href="{{route('subdomains')}}" class="btn btn-warning waves-effect" >Liste des sous domaines</a>
