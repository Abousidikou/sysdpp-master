...
<div class="block-header">
    ...
    <ol class="breadcrumb breadcrumb-col-orange">
        ...
        <li class="active">IMPORTER DES STRUCTURES</li>

    </ol>



    <small>Afin d'importer des structures, choisissez un fichier puis cliquer sur le bouton <strong>Importer</strong></small>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="card">
            ...
            @endif
                ...
                <form id="form_advanced_validation" method="POST" action="{{action('Structure\StructureController@import')}}" enctype="multipart/form-data">
