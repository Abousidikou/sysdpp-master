...
<div class="block-header">
    ...
    <ol class="breadcrumb breadcrumb-col-orange">
        ...
        <li class="active">CREER INDICATEUR</li>
            ...
            <div class="body">
                ...
                @elseif(session('validation'))
                    ...
                    <div class="alert bg-danger alert-dismissible" role="alert">
                        ...
                        Erreur de validation... Il se peut que l'indicateur existe déjà. <br>
                ...
                <form id="form_advanced_validation" method="POST" action="{{action('Indicator\IndicatorController@create')}}">
