...
<div class="block-header">
    ...
    <ol class="breadcrumb breadcrumb-col-orange">
        ...
        <li class="active">IMPORTER DES INDICATEURS</li>

    </ol>



    <small>Afin d'importer des indicateurs, choisissez un fichier puis cliquer sur le bouton <strong>Importer</strong></small>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="card">
            ...
            <div class="header">
                ...
                <h2>IMPORTER DES INDICATEURS</h2>
            ...
            @endif
                ...
                <form id="form_advanced_validation" method="POST" action="{{action('Indicator\IndicatorController@import')}}" enctype="multipart/form-data">
                    ...
                    <a href="{{route('indicators')}}" class="btn btn-warning waves-effect" >Liste des indicateurs</a>
