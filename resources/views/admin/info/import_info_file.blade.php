...
<div class="block-header">
    ...
    <ol class="breadcrumb breadcrumb-col-orange">
        ...
        <li class="active">IMPORTER UN FICHIER</li>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="card">
            ...
            @endif
                ...
                <form id="form_advanced_validation" method="POST" action="{{action('Infos\InfosController@import')}}" enctype="multipart/form-data">
