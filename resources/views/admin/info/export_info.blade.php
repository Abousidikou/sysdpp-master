...
<div class="block-header">
    ...
    <ol class="breadcrumb breadcrumb-col-orange">
        ...
        <li class="active">EXPORTATION DE DONNEES</li>

    </ol>

        

    <small>Afin d'exporter des donnees, remplissez le formulaire puis cliquer sur le bouton <strong>Exporter</strong> </small>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <form id="form_advanced_validation" method="POST" action="{{action('Infos\InfosController@export')}}">
                    ...
                    <button class="btn btn-primary waves-effect" type="submit">EXPORTER</button>
