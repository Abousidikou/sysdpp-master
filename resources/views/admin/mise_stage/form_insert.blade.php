...
<div class="block-header">
    <ol class="breadcrumb breadcrumb-col-orange">
        ...
        <li class="active">INSERTION DES MISES EN STAGE</li>
    </ol>
    ...
    <div class="col-sm-offset-1 col-sm-10 col-xs-10">
        <div class="card">
            ...
            <div class="body">
                ...
                @endif
                <form id="form_advanced_validation" method="POST" action="{{ route('miseEnStage.insert') }}">
                    {{csrf_field()}}
                        ...
                        <h2>Informations</h2>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control"  name="date_demarrage_stage" id="date_demarrage_stage" required>
                                </div>
                                <div class="help-info"></div>
                            </div>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="spec_option"  required>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="ecole_stage" required>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <select name="annee_stage" class="form-control show-tick" data-live-search="true" id="annee_stage" required>
